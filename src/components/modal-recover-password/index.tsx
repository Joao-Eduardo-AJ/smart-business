  ...
  return (
    <>
      <div
        className={`${
          open ? "flex" : "hidden"
        } absolute top-0 w-screen h-screen bg-neutral800/60 z-30`}
        onClick={() => onClose()}
      />
      <div
        className={`${
          open ? "bottom-1/2 translate-y-1/2" : "-bottom-500"
        } flex absolute right-1/2 translate-x-1/2 transition-all duration-500 ease-in-out items-center sd:items-start md:w-742 lg:h-460 z-50`}
      >
        ...
        <div className="px-24 py-24 h-full flex flex-col gap-16 md:px-32 md:pt-40 md:pb-50 lg:px-50 lg:pt-80 lg:pb-100 relative md:w-full bg-white rounded-md lg:rounded-l-none">
          ...
          />
          <div>
            <p className="text-md2 font-semibold lg:text-3.5xl text-neutral700">

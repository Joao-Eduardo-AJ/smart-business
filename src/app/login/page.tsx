...
const Login = () => {
  ...
  const { handleRecoveryVisible, recoveryPassModalVisible } = usePagesContext();

  return (
    <main className="relative bg-white h-screen text-neutral050 text-sd1 lg:flex overflow-hidden">
      <aside className="hidden bg-primaryDefault lg:flex flex-col gap-62 pt-88 lg:px-32 xl:px-88 w-528 relative">
        <Logo logoColor="white" />
        <p className="text-white text-md2 leading-8 xl:text-3.5xl w-328">
          {texts.ASIDE_TITLE}{" "}
      ...
      <div className="w-full px-32 pt-2 lg:pt-32 xl:pt-72 lg:px-90 xl:px-216">
        ...
        <MainForm onClickForgottenPass={() => handleRecoveryVisible()} />
      ...
      <RecoverPasswordModal
        open={recoveryPassModalVisible}
        onClose={() => handleRecoveryVisible()}
      />
    </main>
  );
};
